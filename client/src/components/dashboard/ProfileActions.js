...
const ProfileActions = () => {
  return (
    <div className="btn-group mb-4" role="group">
      <Link to="/edit-profile" className="btn btn-light mr-5">
        <i className="fas fa-user-circle text-success mr-1" /> Edit Profile
      </Link>
      <Link to="/add-experience" className="btn btn-light mr-5">
        <i className="fab fa-black-tie text-success mr-1" />
        Add Experience
      </Link>
      <Link to="/add-education" className="btn btn-light mr-5">
